    ...
    <AppShell>
      <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <p className="mt-3 text-lg text-slate-300">
          $1 al mes para analisis ilimitados. Una pequena inversion para evitar perder mucho mas en una estafa.
        </p>
        <div className="mt-8 rounded-lg border border-trust/40 bg-panel p-6 shadow-glow">
          <div className="mb-6 rounded-md border border-mint/25 bg-mint/10 p-4 text-slate-100">
            Invierte $1 y revisa antes de pagar, enviar productos o abrir links sospechosos.
          </div>
          <ul className="space-y-3 text-slate-200">
            {["Analisis ilimitados", "Historial completo", "Notas de voz", "Prioridad de IA", "Proteccion familiar"].map((item) => (

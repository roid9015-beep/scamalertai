...
- Free plan with 1 analysis per day
...
2. Create a subscription product and plan for `$1.99/month`.
3. Set:
   - `PAYPAL_CLIENT_ID`
...
- Adjust `NEXT_PUBLIC_FREE_ANALYSES_PER_DAY` if you want a different free plan.
